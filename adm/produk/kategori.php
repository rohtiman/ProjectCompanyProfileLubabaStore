        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
					...
					<li>
                        <a class="" href="data_produk.php"><i class="fa fa-desktop "></i>Produk</a>
                    </li>
					<li>
                        <a class="active-menu" href="kategori.php"><i class="fa fa-desktop "></i>Kategori</a>
                    </li>
                    <li>
				...
				<div id="page-inner">
					<div class="row">
						<div class="col-md-12">
							...
							<div class="page-subhead-line">
								<div  align="right">
									<form method="GET" action="pencarianktg.php" enctype="multipart/form-data">
					...
					<div class="box">
						<div class="box-header">
						  <h3 class="box-title" align="center">DATA KATEGORI</h3>
						</div>
						<div class="box-body">
						  <table class="table table-bordered table-striped">
							...
							<tbody>
										<?php
											...
											$i = $start+0;
											$query = "SELECT * FROM kategori order by idkategori asc LIMIT $start, $batas ";
										...
										?>
											<tr>
												...
												<td><a href='editktg.php?id=<?php echo $row['idkategori']; ?>' class="btn btn-info btn-xs"><i class="fa fa-pencil" title="Edit"></i></a></td>
												<td><a href='hapusktg.php?id=<?php echo $row['idkategori']; ?>' onclick="return confirm('anda yakin akan menghapus data ini ?');" class="ask"><button class="btn btn-danger btn-xs" type=""><i class="fa fa-trash-o" title="Hapus"> </i></button></a></td>
						  ...
						  <div align="right">
						  <?php
							$query = "SELECT COUNT(*) AS jumData FROM kategori order by idkategori desc";
							$hasil = mysql_query($query);
						...
						<a href="tambahktg.php" class="bt_green"><button><font color="black">Tambah Kategori</font></button></a>
					 </div>
				</div>
			</div>
    </div>
    <div id="footer-sec">
        &copy; 2017 Lubaba | Design By : <a href="http://www.binarytheme.com/" target="_blank">BinaryTheme.com</a>
    </div>
