        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="home.php"><i class="fa fa-dashboard " href="home.php"></i>Beranda</a>
                    </li>
                    <li>
                        <a class="" href="berita/data_berita.php"><i class="fa fa-desktop "></i>Berita</a>
                    </li>
                    ...
                    <li>
                        <a class="" href="produk/kategori.php"><i class="fa fa-desktop "></i>Kategori</a>
                    </li>
