        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
					...
					<li>
                        <a class="" href="../berita/data_berita.php"><i class="fa fa-dekstop "></i>Berita</a>
                    </li>
					...
					<li>
                        <a class="" href="../contact/data_contact.php"><i class="fa fa-dekstop "></i>Kontak</a>
                    </li>
                    ...
                    <li>
                     ...
                     <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li><a class="active-menu" href="data_akun.php"><i class="fa fa-toggle-on"></i>Data Akun</a></li>
                        </ul>
                    </li>
