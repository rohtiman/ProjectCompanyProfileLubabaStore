        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
					...
					<li>
                        <a href="../../berita/data_berita.php" onclick="return confirm('anda yakin ingin keluar dari jendela ini?')"><i class="fa fa-desktop "></i>Berita dan Event</a>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li><a href="../tours/data_tours.php" onclick="return confirm('anda yakin ingin keluar dari jendela ini?')"><i class="fa fa-eyedropper "></i>Tours</a></li>
                            <li><a class="active-menu" href="data_charter.php" onclick="return confirm('anda yakin ingin keluar dari jendela ini?')"><i class="fa fa-eyedropper"></i>Charter</a></li>
                        </ul>
                    </li>
                    <li>
				...
				<div id="page-inner">
					...
					<div class="col-md-12 col-sm-6 col-xs-12">
                        ...
                        <div class="panel-heading" align="center">
                          <h4>Form Edit Charter</h4>
                        </div>
						<?php
					include ('../../koneksi.php');
					$sql = "SELECT * FROM tb_charter WHERE id_charter='1'";
					$hasil = mysql_query($sql);
					$post = mysql_fetch_array($hasil)			
				  ?>
                        <div class="panel-body">
                            <form role="form" method="post" action="proses_edit_charter.php" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label>Deskripsi Charter</label>
                                    <textarea class="form-control" rows="5" name="deskripsi_charter" required="required"><?php echo $post['des_charter'];?></textarea>
                                </div>
								<div align="center">
						...
						<div align="right"><a href="data_charter.php" class="bt_green"><strong>Kembali ke tabel charter...</strong></a></div>
                    </div>
				</div>
			</div>
    </div>
