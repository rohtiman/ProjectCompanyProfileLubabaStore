        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li><a class="active-menu" href="data_travel.php"><i class="fa fa-eyedropper"></i>Travel</a></li>
            ...
            <div class="row">
				 <div class="col-md-12 col-sm-4">
                    <div class="panel panel-primary">
                        <div class="panel-heading" align="center"><h3>DATA TRAVEL</h3></div>
							<div class="panel-body">
								<p>
										<?php
											include('../../koneksi.php');
											$query = "SELECT * FROM tb_travel WHERE id_travel='1'";
                        ...
                        <div class="panel-footer" align="right">
                            <td><a href="edit_travel.php?id=1" class="btn btn-primary">Edit</a></td>
                        </div>
                    </div>
                </div>
            </div>
