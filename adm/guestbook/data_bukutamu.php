...
<body>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li><a href="../service/travel/data_travel.php"><i class="fa fa-eyedropper"></i>Travel</a></li>
                            <li><a href="../service/tours/data_tours.php"><i class="fa fa-eyedropper "></i>Tours</a></li>
                            <li><a href="../service/charter/data_charter.php"><i class="fa fa-eyedropper"></i>Charter</a></li>
                        </ul>
                    </li>
                    <li>
                        <a class="active-menu" href="data_bukutamu.php"><i class="fa fa-recycle "></i>Buku Tamu </a>
                    </li>
                </ul>
            </div>
        </nav>
	<div id="page-wrapper">
		<div id="page-inner">
			<div class="row">
				<div class="col-md-12">
					<h1 class="page-head-line">BUKU TAMU</h1>
				</div>
			</div>
                 <div class="box">
					<div class="box-header">
					    <h3 class="box-title" align="center">DATA BUKU TAMU</h3>
					</div>
						<div class="box-body">
							...
							<tbody>
										...
										?>
											<tr>
												...
												<td><a href="hapus_bukutamu.php?id=<?php echo $tampil['id_bukutamu']; ?>" onclick="return confirm('anda yakin akan menghapus data ini');"><button class="btn btn-danger" type=""><i class="fa fa-trash-o"></i>&nbsp Hapus</button></a></td>
											</tr> 
										<?php }; ?>  
							</tbody>
						  </table>
